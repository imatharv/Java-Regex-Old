...
The repository contains a java program which compares the input string or number with the predefined regular expression and returns a boolean value whether it is satisfying that regular expression patter or not. The whole thing is programmed in eclipse.
